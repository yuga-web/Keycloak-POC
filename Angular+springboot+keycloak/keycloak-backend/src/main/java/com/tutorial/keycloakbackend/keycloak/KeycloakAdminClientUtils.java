package com.tutorial.keycloakbackend.keycloak;
...
public class KeycloakAdminClientUtils {
    ...
    private String keycloaksecret="332e78cb-0487-46a8-949d-7c2a09cd380c";
    public static KeycloakAdminClientConfig loadConfig(KeycloakPropertyReader keycloakPropertyReader) {
        ...
        try {
            ...
            String clientSecret ="332e78cb-0487-46a8-949d-7c2a09cd380c";
